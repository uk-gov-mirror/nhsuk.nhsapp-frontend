...
title: Contact their GP surgery online
description:
backlogID: 64
order: 2
tags:
...
### 'Ask about a health problem' (Online Consultation or 'OLC')
...
'Ask about a health problem' is only available to users whose GP surgery has an integrated OLC supplier, such as Accurx, eConsult, Engage, PATCHS or Virtually.
...
'Request a letter or information' is only available to users whose GP surgery has an integrated OLC supplier, such as Accurx, eConsult, Engage, PATCHS or Virtually.

<img src="/assets/images/helping-users-contact-gp-image2.png" alt="Helping users request a letter or information" style="border: none; background-color: transparent;">
